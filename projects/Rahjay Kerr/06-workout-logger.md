...
- **AI-Assisted Workout Suggestion:**
  - Add an endpoint that calls an LLM (e.g., OpenAI) and returns a Pydantic-validated structured response. For this theme, that could be suggesting tomorrow's workout (focus area, recommended exercises, and target rep ranges) based on the last 7 days of sessions, returning a structured workout plan with a one-sentence rationale.
- **Rate Limiting:**
