...
- **AI-Assisted Bug Triage:**
  - Add an endpoint that calls an LLM (e.g., OpenAI) and returns a Pydantic-validated structured response. For this theme, that could be classifying a free-form bug report into a structured triage decision — proposed severity, likely component, suggested labels, and a one-sentence rationale.
- **Rate Limiting:**
